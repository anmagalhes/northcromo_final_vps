...
class Produto(Base):
    ...
    grupo_produto = relationship(
        "Grupo_Produto", back_populates="produtos", lazy="joined"
    )
    ...
    posto_trabalho = relationship(
        ...
        foreign_keys=[
            id_posto_trabalho
        ],  # Especificando qual chave estrangeira utilizar
        lazy="joined",
    )
    ...
    checklists = relationship(
        "ChecklistRecebimento", back_populates="produto", lazy="joined"
    )
    usuario = relationship("User", back_populates="produtos", lazy="joined")
    recebimentos = relationship(
        "Recebimento",
        back_populates="produto",
        foreign_keys="Recebimento.cod_produto",
        lazy="joined",
    )
