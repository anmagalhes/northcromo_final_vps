...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # Permite todas as origens (em produção, defina origens específicas)
...
async def log_request(request: Request, call_next):
    ...
    print(f"Corpo da solicitação: {body[:500]}")  # Limite de 500 bytes para evitar prints enormes
