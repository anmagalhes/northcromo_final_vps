                      ...
                      <select
                        ...
                        onChange={e => {
                          ...
                          setEditaveis(prev =>
                            prev.map(el =>
                              el.id === item.id
                                ? { ...el, componente_id: novoId, componente: { id: novoId, componente_nome: nomeSelecionado } }
                                : el
                            )
                          );
                        }}
                      ...
                      <select
                        ...
                        onChange={e => {
                          ...
                          setEditaveis(prev =>
                            prev.map(el =>
                              el.id === item.id
                                ? { ...el, operacao_id: novoId, operacao: { id: novoId, op_nome: nomeSelecionado } }
                                : el
                            )
                          );
                        }}
                      ...
                      <select
                        ...
                        onChange={e => {
                          ...
                          setEditaveis(prev =>
                            prev.map(el =>
                              el.id === item.id
                                ? { ...el, posto_trabalho_id: novoId, posto_trabalho: { id: novoId, posto_trabalho_nome: nomeSelecionado } }
                                : el
                            )
                          );
                        }}
