...
# Caminho do ambiente virtual (confirmado que o diretório correto é /var/www/northcromo_final_vps/backend/venv)
VENV_DIR="$PROJECT_DIR/backend/venv"  # Este caminho já está correto
