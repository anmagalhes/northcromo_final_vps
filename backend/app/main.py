...
from app.user.routes import router as user_router  # Importando o router de usuários
from app.defeito.routes import router as defeito_router  # Importando o router de defeitos
from app.checklist_recebimento.routes import router as checklist_router  # Ajuste nos imports
from app.foto_recebimento.routes import router as foto_router
from app.funcionario.routes import router as funcionario_router
from app.cliente.routes import router as cliente_router
from app.componente.routes import router as componente_router
...
SQLALCHEMY_DATABASE_URL = os.getenv("DATABASE_URL", Config.SQLALCHEMY_DATABASE_URL)
